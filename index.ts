...
const server = Bun.serve({
  ...
  routes: {
    ...
    [devScriptPath]: staticAssetResponse(devScriptOutput.path, "text/javascript; charset=utf-8"),
    [devStylePath]: staticAssetResponse(devStyleOutput.path, "text/css; charset=utf-8"),
