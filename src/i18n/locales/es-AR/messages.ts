...
export const esARMessages = {
  ...
  paymentAmountOptionalOverride: 'Monto de la cuota (opcional)',
  ...
  fieldNoteEarDisabled:
    'Se desactiva cuando indicás un monto de pago. La aplicación calcula la TAE a partir de ese valor.',
  fieldNoteEarFormat:
  ...
  chartPrerendered:
    'Se muestra una vista previa del gráfico prerenderizado. El gráfico interactivo se activa apenas termina de cargar.',
  chartInteractive:
  ...
  paymentIsRequired: 'El monto del pago es obligatorio',
  ...
  seoDescription:
    'Amorta es una calculadora interactiva de amortización francesa con resultados compartibles, cálculo de la tasa a partir del pago y una visualización del desglose entre capital e intereses.',
  seoDescriptionShare:
  ...
  homepageArticlesDescription:
    'Lecturas breves sobre lo que hay detrás de un préstamo. Cómo se acumula el interés, cuánto cuestan las comisiones y las decisiones chicas que cambian el total.',
  ...
  seoDescriptionContact:
    'Ponete en contacto con el equipo de Amorta. Escribinos por correo electrónico si tenés preguntas, comentarios o necesitás ayuda con nuestra calculadora de amortización francesa.',
  seoDescriptionTerms:
  ...
  articleCalculatingRemainingLoanBalanceDescription:
    'Aprendé las fórmulas matemáticas y métodos para calcular tu saldo exacto en cualquier punto del préstamo, incluyendo ejemplos prácticos y errores comunes a evitar.',
  ...
  articleBalloonPaymentLoanDescription:
    'Aprendé cómo funciona un préstamo con pago globo, por qué mantiene cuotas más bajas y qué riesgos aparecen cuando vence un saldo final alto.',
  ...
  articleBalloonPaymentLoanSeoDescription:
    'Aprendé cómo funciona un préstamo con pago globo, por qué deja un saldo final alto, y qué riesgos de liquidez y refinanciación conviene revisar.',
  articleLoanOriginationFeeTitle:
    'Qué es la Comisión de Apertura de un Préstamo',
  articleLoanOriginationFeeDescription:
    'Aprendé qué cubre la comisión de apertura, cómo cambia el dinero inicial que necesitás, y por qué modifica el costo real del préstamo.',
  ...
  articleLoanOriginationFeeSeoDescription:
    'Aprendé qué es la comisión de apertura, cómo afecta a la TAE y a los costos de cierre, y cuándo una comisión mayor puede compensar.',
  articlePrepaymentPenaltyTitle:
    'Qué es una Penalización por Cancelación Anticipada',
  articlePrepaymentPenaltyDescription:
    'Aprendé qué es una penalización por cancelación anticipada, cuándo se aplica y cómo puede cambiar el valor real de refinanciar o amortizar antes.',
  ...
  articleInterestAccrualBetweenPaymentsDescription:
    'Aprendé cómo calculan las entidades los intereses entre fechas de pago, por qué importa el calendario y cómo cambia el costo real del préstamo.',
  ...
  articleUnderstandingLtvAndPmiDescription:
    'Aprendé cómo la relación préstamo-valor determina cuándo se requiere el seguro de protección de pagos, cómo funcionan sus costos y las reglas para eliminarlo al 80% y 78% LTV.',
  ...
  articleMortgageEscrowAccountDescription:
    'Descubrí cómo funciona una cuenta escrow hipotecaria, cómo se calcula tu pago mensual completo y por qué los impuestos y seguros cambian tu cuota sin afectar tu saldo.',
  ...
  articleMortgageEscrowAccountSeoDescription:
    'Aprendé cómo funcionan las cuentas escrow hipotecarias, cómo los impuestos y seguros elevan tu pago mensual y qué permite la regla de reserva RESPA.',
