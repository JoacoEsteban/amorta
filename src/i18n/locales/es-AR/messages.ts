export const esARMessages = {
  ...
  privacyIntroductionText: 'Esta Política de Privacidad describe cómo Amorta ("nosotros", "nos" o "nuestro") recopila, utiliza y protege tu información cuando usás nuestro sitio web. Estamos comprometidos con proteger tu privacidad y garantizar transparencia sobre nuestras prácticas de datos.',
  ...
  privacyDataCollectionPersonal: 'Información Personal: No recopilamos información personal a menos que nos contactés voluntariamente por correo electrónico.',
  ...
  privacyThirdPartyCookies: 'Estos terceros pueden utilizar cookies para mostrar anuncios basados en tus visitas anteriores a este sitio web y otros sitios en Internet. Podés optar por no recibir publicidad personalizada visitando la Configuración de Anuncios de Google.',
  privacyUserRightsTitle: 'Tus Derechos',
  privacyUserRightsText: 'Tenés derecho a controlar tus datos. Podés desactivar las cookies a través de la configuración de tu navegador en cualquier momento. Tené en cuenta que desactivar las cookies puede afectar la funcionalidad de ciertas características de nuestro sitio web.',
  privacyContactTitle: 'Contactanos',
  privacyContactText: 'Si tenés alguna pregunta o inquietud sobre esta Política de Privacidad o nuestras prácticas de datos, por favor contactanos en:',
  contactEmail: 'privacy@amorta.app',
  aboutTitle: 'Acerca de Amorta',
  aboutIdentityTitle: 'Quiénes Somos',
  aboutIdentityText: 'Amorta es un proyecto independiente creado y mantenido por joaco.io. Somos un pequeño equipo apasionado por hacer que las herramientas financieras sean accesibles y fáciles de entender para todos.',
  ...
  contactResponseText: 'Nuestro objetivo es responder a todas las consultas dentro de 2-3 días hábiles. Para problemas técnicos o reportes de errores, por favor incluí detalles sobre tu navegador y dispositivo para ayudarnos a asistirte más efectivamente.',
  termsTitle: 'Términos y Condiciones',
  termsAcceptanceTitle: 'Aceptación de los Términos',
  termsAcceptanceText: 'Al acceder y usar Amorta, aceptás y te comprometés a cumplir con estos Términos y Condiciones. Si no estás de acuerdo con alguna parte de estos términos, por favor no uses nuestro sitio web.',
  termsContentUseTitle: 'Uso del Contenido',
  termsContentUseText: 'Todo el contenido de Amorta se proporciona únicamente con fines informativos y educativos. Podés usar la calculadora y leer nuestros artículos para uso personal, no comercial. No podés reproducir, distribuir, modificar o crear trabajos derivados de nuestro contenido sin permiso escrito explícito.',
  ...
  seoDescriptionPrivacyPolicy: 'Leé nuestra Política de Privacidad para entender cómo Amorta recopila, utiliza y protege tu información. Informate sobre cookies, servicios de terceros incluyendo Google AdSense, y tus derechos de privacidad.',
  seoDescriptionAbout: 'Conocé Amorta, una calculadora gratuita de amortización francesa. Descubrí quiénes somos, lo que ofrecemos y nuestro compromiso con la educación financiera precisa.',
  seoDescriptionContact: 'Ponete en contacto con el equipo de Amorta. Contactanos por correo electrónico para preguntas, comentarios o soporte sobre nuestra calculadora de amortización francesa.',
  seoDescriptionTerms: 'Leé nuestros Términos y Condiciones para entender las reglas y regulaciones para usar la calculadora de amortización francesa y el contenido educativo de Amorta.',
  aboutLink: 'Acerca de',
