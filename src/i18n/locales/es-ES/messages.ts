...
export const esESMessages = {
  ...
  articleMortgageRecastDescription:
    'Aprende cómo funciona una recast hipotecaria, cuándo la permite la entidad y por qué un pago grande de capital puede reducir tu cuota obligatoria.',
  ...
  articleLoanGracePeriodDescription:
    'Aprende qué hace un período de gracia, qué no cambia y por qué pagar dentro de esa ventana no siempre evita intereses o reglas de mora.',
  ...
  articleMortgageRateLockDescription:
    'Aprende qué es un bloqueo de tasa hipotecaria, cuánto tiempo puedes bloquear tu tipo, cuánto cuesta y por qué el momento del bloqueo importa antes del cierre.',
  ...
  articleMortgageRateLockSeoDescription:
    'Descubre cómo los bloqueos de tasa protegen tu tipo de interés antes del cierre, cuánto cuestan, cuándo pueden anularse y cómo elegir el período adecuado.',
  articleLoanPayoffStatementTitle:
    'Qué es un Extracto de Liquidación de Préstamo',
  articleLoanPayoffStatementDescription:
    'Aprende qué incluye un extracto de liquidación, por qué no coincide siempre con tu saldo y cómo la entidad calcula el importe exacto de cierre.',
  articleLoanPayoffStatementDate: '14 de Abril de 2026',
  articleLoanPayoffStatementBody,
  articleLoanPayoffStatementSeoTitle:
    'Qué es un Extracto de Liquidación de Préstamo | Amorta',
  articleLoanPayoffStatementSeoDescription:
    'Aprende qué es un extracto de liquidación, por qué el importe final difiere del saldo de capital y cómo influyen los intereses diarios.',
  articleMortgageDiscountPointsTitle: '¿Qué son los puntos de descuento hipotecario?',
  articleMortgageDiscountPointsDescription:
    'Aprende cómo funcionan los puntos de descuento hipotecario, cuánto cuesta cada punto y cómo calcular si comprar puntos ahorra dinero durante la vida del préstamo.',
  ...
  articleMortgageDiscountPointsSeoDescription:
    'Aprende qué son los puntos de descuento hipotecario, cómo reducen tu tipo, cómo calcular el punto de equilibrio y cuándo comprar puntos tiene sentido financiero.',
  articleArmRateCapsTitle: 'Topes de tasa en hipotecas ARM: cómo los límites protegen tu pago',
  articleArmRateCapsDescription:
    'Descubre cómo funcionan los topes de tasa en las hipotecas de tipo ajustable, qué significa la estructura 2/2/5 y por qué los topes pueden crear trampas de intereses diferidos.',
  ...
  consentCookieBannerDescription:
    'Usamos cookies para operar el sitio, medir uso y mostrar publicidad. Puedes aceptar, rechazar o personalizar tus preferencias.',
  consentDialogTitle: 'Preferencias de privacidad',
  consentDialogDescription:
    'Controla cómo usamos cookies y tecnologías similares en Amorta.',
  ...
  consentMarketingDescription:
    'Permiten mostrar anuncios más relevantes para ti.',
}
