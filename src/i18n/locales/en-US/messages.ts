export const enUSMessages = {
  ...
  articleExtraPaymentsBody: `
    <p>One of the most effective ways to save money on a loan is to make extra payments toward the principal. Even small additional amounts can have an outsized impact over time, shaving years off your loan and thousands off the total interest paid.</p>
    <h2>How extra payments work</h2>
    <p>In French amortization, every payment is split between interest and principal. The interest is calculated on the remaining balance, so when you reduce the principal faster, less interest accrues in subsequent periods.</p>
    ...
    <p>Consider a $300,000 mortgage at 6% EAR over 30 years. The monthly payment is approximately $1,798. Without extra payments, you would pay $347,200 in total interest over the life of the loan.</p>
    <p>Now suppose you pay an extra $200 per month. After 30 years, you would have paid only $240,600 in interest &mdash; a savings of over $106,000. And you would have paid off the loan about 7 years early.</p>
    <p>Make the same $200 extra payment, but wait until year 15 to start. The savings drop to about $28,000 and you only shave 3 years off the term. The timing matters enormously.</p>
    <h2>Types of extra payments</h2>
    <p>There are two main approaches to extra payments:</p>
    <ul>
      <li><strong>Recurring extra payments</strong>: Adding a fixed amount to each monthly payment. For example, paying $1,998 instead of $1,798 every month.</li>
