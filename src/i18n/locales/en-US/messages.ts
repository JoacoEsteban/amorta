...
export const enUSMessages = {
  ...
  articleAprVsEarDate: 'March 31, 2026',
  articleAprVsEarBody,
  ...
  articleUnderstandingAmortizationScheduleDate: 'March 31, 2026',
  ...
  articleExtraPaymentsDescription:
    'Learn how making extra payments toward your principal can dramatically reduce total interest and shorten your loan term.',
  articleExtraPaymentsDate: 'March 31, 2026',
  ...
  privacyCookiesText:
    'We use cookies and similar tracking technologies to enhance your browsing experience. Cookies are small text files stored on your device that help us understand user behavior and preferences.',
  privacyCookiesPurpose:
    'Our cookies are used for: remembering your preferences, analyzing site traffic, and serving personalized advertisements through third-party services.',
  privacyThirdPartyTitle: 'Third-Party Services',
  privacyThirdPartyText:
    'We use third-party services to enhance our website functionality and monetization.',
  ...
  privacyThirdPartyCookies:
    "These third parties may use cookies to serve ads based on your prior visits to this website and other sites on the Internet. You can opt out of personalized advertising by visiting Google's Ads Settings.",
  ...
  aboutPurposeText:
    'Amorta provides a free, interactive French amortization calculator that helps users understand loan repayment schedules, visualize principal and interest breakdowns, and compare different loan scenarios. Our tools are designed to empower users with clear, accurate financial calculations.',
  aboutAudienceTitle: 'Who Our Content Is For',
  aboutAudienceText:
    'Our content is designed for anyone interested in understanding loan amortization, including: home buyers comparing mortgage options, financial students learning about amortization methods, real estate professionals needing quick calculations, and anyone planning a major purchase requiring a loan.',
  aboutCredibilityTitle: 'Our Expertise',
  aboutCredibilityText:
    'While we are not a financial institution, our calculator is built on established financial mathematics and thoroughly tested against industry standards. We are committed to accuracy and transparency in all our calculations and explanations.',
  aboutTransparencyTitle: 'Editorial Intent',
  aboutTransparencyText:
    'Amorta is an informational and educational tool. We do not provide financial advice. Our goal is to help users understand the mechanics of French amortization and make informed decisions. Always consult with a qualified financial advisor for personal financial decisions.',
  ...
  contactResponseText:
    'We aim to respond to all inquiries within 2-3 business days. For technical issues or bug reports, please include details about your browser and device to help us assist you more effectively.',
  ...
  termsLiabilityText:
    'Amorta provides its tools and content "as is" without warranties of any kind. While we strive for accuracy, we do not guarantee that our calculator results are error-free or suitable for your specific situation. We are not liable for any financial decisions made based on information from this website.',
  ...
  seoDescriptionAbout:
    'Learn about Amorta, a free French amortization calculator. Discover who we are, what we provide, and our commitment to accurate financial education.',
  seoDescriptionContact:
    'Get in touch with the Amorta team. Contact us via email for questions, feedback, or support regarding our French amortization calculator.',
  seoDescriptionTerms:
    "Read our Terms & Conditions to understand the rules and regulations for using Amorta's French amortization calculator and educational content.",
  aboutLink: 'About',
  contactLink: 'Contact',
  ...
  articleComparingLoanOffersDescription:
    'Learn a systematic approach to compare loan offers beyond interest rates, including fees, terms, prepayment penalties, and total cost of borrowing.',
  articleComparingLoanOffersDate: 'April 7, 2026',
  ...
  articleBalloonPaymentLoanDescription:
    'Learn how a balloon payment loan works, why scheduled payments stay lower, and what risks arise when a large balance comes due at maturity.',
  articleBalloonPaymentLoanDate: 'April 8, 2026',
  ...
  articleMortgageRecastDescription:
    'Learn how a mortgage recast works, when lenders allow it, and why a large principal payment can lower your required monthly payment.',
  articleMortgageRecastDate: 'April 11, 2026',
  ...
  articleUnderstandingLtvAndPmiTitle: 'Understanding LTV and PMI: The 80% Threshold That Controls Mortgage Insurance',
  articleUnderstandingLtvAndPmiDescription:
    'Learn how loan-to-value ratio determines when private mortgage insurance is required, how PMI costs work, and the rules for removing it at 80% and 78% LTV.',
  articleUnderstandingLtvAndPmiDate: 'April 22, 2026',
  articleUnderstandingLtvAndPmiBody,
  articleUnderstandingLtvAndPmiSeoTitle: 'Understanding LTV and PMI: The 80% Mortgage Insurance Threshold | Amorta',
  articleUnderstandingLtvAndPmiSeoDescription:
    'Learn how loan-to-value ratio determines private mortgage insurance requirements, PMI costs, and cancellation rules at 80% and 78% LTV thresholds.',
  ...
  articleLoanPayoffStatementSeoDescription:
    'Learn what a loan payoff statement is, why payoff amounts differ from principal balance, and how per-diem interest affects the final settlement figure.',
  articleMortgageDiscountPointsTitle: 'What Are Mortgage Discount Points?',
  articleMortgageDiscountPointsDescription:
    'Learn how mortgage discount points work, what each point costs, and how to calculate whether buying points saves money over the life of your loan.',
  articleMortgageDiscountPointsDate: 'April 28, 2026',
  ...
  articleMortgageEscrowAccountDescription:
    'Learn what a mortgage escrow account does, how your monthly PITI payment is calculated, and why taxes and insurance can change your payment without affecting your loan balance.',
  articleMortgageEscrowAccountDate: 'May 4, 2026',
  ...
  consentCookieBannerDescription:
    'We use cookies to run the site, measure usage, and serve ads. You can accept, reject, or customize your preferences.',
